...
export const DEMO_PRACTITIONERS = [
  { id: "1", name: "Lisa", role: "Facial, Lash Lift & Brow Artist", specialty: "Brows, Facials & Skin", color: "#C9A96E", photo: "/team/Lisa.jpg", instagram: "@elisehouseuk" },
...
export const TREATMENT_CATEGORIES = [
  { id: "manicures", title: "Manicures", icon: "✦", description: "Gel manicures, acrylics, BIAB & nail art", practitioners: ["Kristen", "Inke", "Melissa"] },
  { id: "pedicures", title: "Pedicures", icon: "✦", description: "Gel toes & pedicures", practitioners: ["Holly", "Melissa"] },
